...
public class TesteMetodos {
	...
	public static void main(String[] args) throws ParseException {
		...
		double mediaTeste = 50.0;
		System.out.println("MotoTaxistas com média ABAIXO de " + mediaTeste + " " + emp1.mototaxistasComMediaAbaixoDe(mediaTeste));
		double mediaTeste2 = 20.0;
		System.out.println("MotoTaxistas com média ACIMA de " + mediaTeste2 + " " + emp1.mototaxistasComMediaAcimaDe(mediaTeste2));
